...
This is my compilation of notes for the Workshop on SoC design planning usign the Google-SkyWater 130nm process node within the [OpenLANE](https://github.com/The-OpenROAD-Project/OpenLane) flow.
## Contents
